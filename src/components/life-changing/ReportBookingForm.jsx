...
//             // Show thank you message with 24-hour wait notice
//             showToast(
//               "success",
//               `Thank you for your payment! Your payment ID: ${response.razorpay_payment_id}. Please wait for 24 hours to get your report.`,
    ...
    <div className="booking-fullscreen-overlay">
      ...
      <div className="booking-fullscreen-container">
        <h1 className="booking-main-title">
          {showThankYou ? "Thank You for Your Payment!" : "Book Your Life Changing Report"}
        </h1>

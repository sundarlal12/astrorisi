...
//       <p className="thank-you-subtitle-small">Your VarshPhal Report will be ready in 24 hours</p>
...
//       <div className="booking-fullscreen-container">
//         <h1 className="booking-main-title">
//           {showThankYou ? "Thank You for Your Payment!" : "Book Your VarshPhal Report"}
//         </h1>
...
//       <h3 className="thank-you-title-small">Payment Successful!</h3>
//       <p className="thank-you-subtitle-small">Your VarshPhal 2026  Report will be ready in 24 hours</p>
...
const ThankYouMessage = ({ paymentId, bookingId, onClose, selectedPlan }) => {
  return (
    <div className="thank-you-compact">
      ...
      <h3 className="thank-you-title-small">Payment Successful!</h3>
      <p className="thank-you-subtitle-small">
        Your VarshPhal 2026 Report will be ready in 24 hours
      </p>
...
const ReportBookingForm = ({ selectedPlan, onClose }) => {
  ...
  const handlePayment = async (e) => {
    ...
    const currentBookingId = data[0].id;
            ...
            {showThankYou ? (
              ...
              <form className="booking-form" onSubmit={handlePayment}>
                ...
                <div className="addon-section">
                  <div className="addon-card">
                    <label className="addon-checkbox-wrapper">
                      <input type="checkbox" name="addConsultation" checked={formData.addConsultation} onChange={handleChange} />
                      <div className="addon-text">
                        <h4>Astro Consultation ₹5100 (+₹2100)</h4>
                        <p>Talk to astrologer one-on-one</p>
                      </div>
